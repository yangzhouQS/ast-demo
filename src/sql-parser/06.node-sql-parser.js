...
const Parser = sqlParser.default.Parser
const parser = new Parser();
const ast = parser.astify(`with /*& tenant:'gslq4dev' */  recursive  org_tree as(
...
select * from org_tree;`); // mysql sql grammer parsed by default
